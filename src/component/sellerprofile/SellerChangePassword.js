            ...
            <div className="all-form-width">
                <form action="">
                    ...
                    <div className="row mt-5">
                        ...
                        <div className="col-md-6">
                            <div className="mb-3">
                                <label for="cpassword" className="form-label">Confirm New Password</label>
                        ...
                        <div className="col-md-6">
                            <div className="mb-3">
                                ...
                                <div className="fomr-three-btn">
                                    <button onClick={() => { props.changeTabsFunction(1) }} className="plant_btn">SAVE<img src={arrowright} alt="" className="img-fluid ml-2" /></button>
                                </div>
                            </div>
                        </div>
                    </div>
