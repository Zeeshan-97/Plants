...
import "../../assets/style/sellerlogin.css";
...
const SellerLogin = () => {
  return (
    <div>
      ...
      <section className="sellerlogin_page">
        <div className="container">
          <div className="row">
            <div className="col-md-5 align-self-center">
              <div className="heading_top mt-5">
                <h3 className="green_head">LOGIN AS A SELLER</h3>
              </div>
                ...
                <form action="">
                  <div className="form-start">
                    ...
                    <div className="button-group">
                      <Link className="plants_btn btn" to="/selleraccount">
                        LOGIN
                      </Link>
                    </div>
                    <div className="rememberDv">
                      ...
                      <div className="lnk">
                        <Link to="/sellerforgetpassword">Forgot Password ?</Link>
                      </div>
                    </div>
                  </div>
                </form>
